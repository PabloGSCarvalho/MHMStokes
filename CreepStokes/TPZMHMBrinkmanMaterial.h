...
class TPZMHMBrinkmanMaterial : public TPZMatWithMem<TPZFMatrix<STATE>, TPZDiscontinuousGalerkin >  {
...
public:
     ...
     */
    TPZMHMBrinkmanMaterial(int matid, int dimension, int space, STATE viscosity, STATE theta, STATE Sigma);
    
    
    /** Creates a material object based on the referred object and
     *  inserts it in the vector of material pointers of the mesh.
     */
    TPZMHMBrinkmanMaterial(const TPZMHMBrinkmanMaterial &mat);
